...
export default function AdminTVPage() {
  ...
  const handleCopyUrl = (screenId: string) => {
    const url = `${window.location.origin}/resta3/tv/pantalla/${screenId}`
      ...
      <div className="border-t animate-in fade-in slide-in-from-top-2 duration-200" style={{ borderColor: S.border }} onClick={(e) => e.stopPropagation()}>
        ...
        <div className="px-5 md:px-6 pt-5">
          ...
          <div className="flex items-center gap-2 border rounded-lg p-1.5 pl-3" style={field}>
            ...
            <code className="flex-1 min-w-0 truncate text-sm text-blue-400 font-mono">{origin}/resta3/tv/pantalla/{screen.id}</code>
            <button
            ...
            <a
              href={`/resta3/tv/pantalla/${screen.id}`}
              target="_blank"
                           ...
                           >
                              ...
                              >
                                 ...
                                 <div className="min-w-0 flex-1">
                                    ...
                                    <code className="block mt-1 text-[11px] truncate font-mono" style={{ color: S.sub }}>/resta3/tv/pantalla/{s.id}</code>
                                 </div>
